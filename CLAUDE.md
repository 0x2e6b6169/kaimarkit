...
Warteschlange zog `api.ts`, `download.ts` und `App.vue` mit, sonst wäre der Baum nicht
mehr typprüfbar gewesen. Ein Textticket besitzt selten nur den Test seiner eigenen
Datei. Zusicherungen auf
